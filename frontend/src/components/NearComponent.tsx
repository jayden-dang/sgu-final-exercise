...
export function SignInPrompt({ greeting, onClick }: { greeting: string; onClick: () => void }) {
    return (
        <main>
            <h1>
            ...
            <p>
                Your contract is storing a greeting message in the NEAR blockchain. To change it you need to sign in
...
export function SignOutButton({ accountId, onClick }: { accountId: string; onClick: () => void }) {
    return (
    ...
    return (
        <>
            ...
            <ol>
                ...
                <li>
                    Ultimately, this <code>contract</code> code is defined in <code>./contract</code> – this is the
                ...
                <li>
                    When you run <code>npm run deploy</code>, the code in <code>./contract</code> gets deployed to the
                    NEAR testnet. You can see how this happens by looking in <code>package.json</code>.
                </li>
            </ol>
            <hr />
            <p>
